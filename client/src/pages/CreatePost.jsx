...
const CreatePost = () => {
  ...
  const generateImg = async () => {
    if (!form.prompt) {
      return alert("Please provide a prompt");
    }
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Create imaginative and visually stunning images generated by DALL-E AI and share them to the community</p>
      </div>
